...
namespace azure_proto_core
{
    ...
    {
#pragma warning disable CS8618, CS8603, CS8604, CS8767, CS8601
        ...
        public IDictionary<string, string> _partsDictionary = new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase);
